...
PLS as a method has an emphasis on predicting the responses and not necessarily in understanding the underlying relationship.

The idea of PLS is to extract underlying (*latent*) factors accounting for as much of the variation of the factor while modelling the responses as well.
